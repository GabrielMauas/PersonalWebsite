        ...
        <div className="">
            <section className="section skills" id="skills">
                ...
                <div className="skills-container">
                    ...
                    <h3 className="skills-title"><i className="bx bx-code"></i>Development</h3>
                    ...
                    <h3 className="skills-title"><i className="bx bx-world"></i>Languages</h3>
                    <div className="skills-list"> 
                        <p className="skills-item"><i className="bx bxs-message-rounded-detail"></i>Spanish</p>
                        <p className="skills-item"><i className="bx bxs-message-rounded-detail"></i>English</p>
                        <p className="skills-item"><i className="bx bxs-message-rounded-detail"></i>Hebrew</p>
                    </div>
